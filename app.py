...
# --- 1. ニーズリスト ---
DEFAULT_NEEDS = [
    "受容", "空気", "イキイキさ", "価値の承認", "意識を向ける・向けられる", 
    "(自分に)本物である", "自主性", "気づき", "美しさ", "帰属", 
    "気にかける、ケアする・される", "祝福する", "挑戦", "選択", "明確さ", 
    "気の置けなさ", "コミュニティ", "人との交流", "思いやり", "能力", 
    "つながり", "自覚的であること", "配慮", "一貫性", "貢献", 
    "協力", "創造性", "尊厳", "発見", "多様性", 
    "気楽さ", "効果的であること", "感情的な安全性", "共感", "平等", 
    "探求", "信念", "流れ", "食べ物", "自由", 
    "楽しみ", "成長", "調和", "癒し", "健康", 
    "正直さ", "希望", "ユーモア", "（一部として）含まれること", "自立", 
    "自発性", "インスピレーション・直感", "統合", "言行一致・誠実さ", "相互依存", 
    "親密さ", "よろこび", "親切にする・される", "学び", "愛", 
    "自己価値の承認", "意味", "悼む、嘆く", "動き", "相互承認", 
    "お互いが満たされていること", "慈しみ", "秩序", "参加", "平和", 
    "心の平安", "身体の安全性", "あそび", "ニーズを満たす力", "存在感・在ること", 
    "守る", "目的", "認知・承認する", "元気回復", "尊重・尊敬", 
    "休息", "安全の保障", "自己受容", "自己表現", "自己実現", 
    "自分で責任をとること", "性的な表現", "分かち合う", "身を守る場所", "空間、場", 
    "スピリチュアルな表現", "安定", "刺激", "支え", "生命・生活の維持", 
    "優しさ", "聴いてもらえること", "知ってもらえること", "見てもらえること", "理解されること", 
    "大事にする・される", "触れること", "信頼", "理解すること", "あたたかさ", 
    "水", "心身の健やかさ"
]
