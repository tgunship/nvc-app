...
# --- 1. ニーズリスト ---
DEFAULT_NEEDS = [
    "生命・生活の維持", "休息", "動き", "触れること", "身体の安全性", 
    "感情的な安全性", "健康", "(自分に)本物である", "正直さ", "言行一致・誠実さ", 
    "つながり", "共感", "理解されること", "聴いてもらえること", "愛", 
    "帰属", "親密さ", "尊重・尊敬", "思いやり", "信頼", 
    "協力", "支え", "コミュニティ", "お互いが満たされていること", "価値の承認", 
    "あそび", "ユーモア", "よろこび", "平和", "美しさ", 
    "調和", "平等", "秩序", "自主性", "自由", 
    "選択", "空間、場", "意味", "目的", "成長", 
    "学び", "創造性", "貢献", "自己表現", "悼む、嘆く", 
    "気づき", "明確さ", "参加", "自己実現", "発見"
]
