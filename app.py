...
DEFAULT_NEEDS = [
    "共感", "受容", "理解", "尊重", "思いやり", 
    "信頼", "所属", "愛", "感謝", "親密さ", 
    "つながり", "支え・協力", "関心", "循環・相互性", "自由・選択", 
    "自律", "スペース", "自発性", "自分に本物であること", "言行一致・誠実さ", 
    "自己表現", "意味・目的", "貢献", "成長", "探求・発見", 
    "創造性", "内なる力", "効力感・達成", "明確さ", "嘆き・悼み", 
    "インスピレーション・直感", "平和・調和", "ただ在ること", "流れ・フロー", "秩序", 
    "公平・対等", "美", "身体の安全", "安心", "休息", 
    "尊厳", "ふれあい", "活力・いのちの躍動", "希望", "安らげる居場所", 
    "遊び・気軽さ", "喜び", "祝福", "挑戦・刺激", "仲間", 
    "ゆるし", "承認", "共鳴・一体感", "境界線", "無防備さ"
]

st.title("🎯 ニーズ アハ！")
# タイトルの直下に小さくバージョン情報を表示
st.markdown("<div style='font-size: 14px; color: #888888; margin-top: -15px; margin-bottom: 10px;'>1枚ずつ版 Ver1.01</div>", unsafe_allow_html=True)
